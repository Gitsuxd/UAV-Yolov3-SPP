...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'dwbottleneck.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='dwbottleneck', help='save to project/name')
