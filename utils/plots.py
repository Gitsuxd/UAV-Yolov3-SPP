...
def feature_visualization(x, module_type, stage, n=18, save_dir=Path('runs/detect/exp')):
    """
    ...
    if 'Detect' not in module_type:
        ...
        if height > 1 and width > 1:
            ...
            fig, ax = plt.subplots(math.ceil(n / 6), 6, tight_layout=True, figsize=(10,3.4))  # 8 rows x n/8 cols
            ax = ax.ravel()
